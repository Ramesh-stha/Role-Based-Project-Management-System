...
const data = [
  { id: 1, name: "Total Members", phone: "5+", icon: "fa-person" },
  { id: 2, name: "Total Manager", phone: "100 +", icon: "fa-user" },
  { id: 3, name: "Total Project", phone: "10+", icon: "fa-user" },
];
...
if(!countproject){
  ...
  return (
    <div className="">
      ...
      <main className="mt-3">
        <section className="grid grid-col-1 sm:grid-cols-3  items-center  gap-5  ">
            ...
            >
              ...
              <i
                className={`fa-solid fa-file text-red-400 p-4 mr-5  text-lg `}
              />
            </div>  
              <div
              className=" flex bg-gradient-to-r from-blue-400 to-purple-400 justify-between  shadow-md w-60 h-25  sm:w-85 sm:h-30 rounded-md p-2  "
        ...
        <section className="flex flex-col sm:flex-row items-center sm:items-start gap-6 mt-4">
          <UserList />
          <div className="w-64 mt-4 h-64 bg-gray-400 shadow-md rounded-md p-2">
            <MyPieChart />
          </div>
        </section>
      </main>
