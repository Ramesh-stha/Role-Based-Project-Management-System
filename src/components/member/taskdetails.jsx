...
const router =useRouter();
    ...
    return(
        ...
        {Project.map((item)=>(
            <div key={item.id} className=" flex  gap-4 bg-white rounded-lg shadow-md p-4 hover:shadow-lg transition" onClick={()=>handlecard(item.id)} >
               <Image className=" " src={item.photo} alt="Invalid Image" width={100} height={25}/>
           <div>
